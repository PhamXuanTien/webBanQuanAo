...
margin-top: 20px; line-height: 50px;">
    ...
    <table>
        ...
        echo "<tr>";
           ...
           echo "<td><a href='xoagh.php?id=$row[id]'><img  id='img' src='products/delete-24.ico'/></a></td>";
        echo "</tr>";
                }
        
          $_SESSION['tien']=$thanhtien;
        echo "<tr style='background: white;'>" ;  
        echo "    <td colspan='2'><a href='admin.php' style='text-decoration: none;font-size: 15px; font-weight: bold; '><div id='shop'>Tiếp tục mua hàng</div></a></td>";
