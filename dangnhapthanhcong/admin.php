	...
	<div id="wrapper">
    	<div id="top">
            ...
            <div id="top-right">
            	...
            	<ul>
                	<li><a href="#"><img src="../png/login.png" style="position:absolute; right: 193px;top:11px;"/></a></li>
                    <li>|</li>
        ...
        <div id="lh_1">
            ...
            <img src="products/giolamviec.png" width='200px' height='100px'/>
         </div>
         </div>
    
         <div id="content-center">
         	<div id="quangcao"><img src="../products/WAMmwq - Copy.jpg"  width="480px" height="150px"/> </div>
            <div class="sanpham">
        ...
        <div id="footer">   
            ...
            <div class="bottom" id="footer-right">
                ...
                <ul>
                	...
                	<li><a href="#">Địa chỉ: 21 Lê Văn Lương, Thanh Xuân, Hà Nội.
</a></li>
                    <li><a href="#">Số ĐKKD: 0377776357</a></li>
                </ul>
            </div>
        </div>
        <div id="thuonghieu">
