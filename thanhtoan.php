    ...
    if(isset($_POST['ok'])){
        ...
        if($user && $phone && $email && $diachi){
            ...
            foreach($_SESSION['giohang'] as $key=>$value){
                mysqli_query($conn,"insert into chitiet_hoadon (id_hoadon,id_sp,soluong) values ('$id_hoadon','$key','$value')");
               }
               $loi['insert']='Cảm ơn quý khách đã thanh toán thành công'.'<a href="index.php"><div class="bottom_f">Về trang chủ</div></a>';
            } else{
                $loi['loitt']='Bạn đã thanh toán đơn hàng '.'<a href="index.php"><div class="bottom_f">Về trang chủ</div></a>';
            }
