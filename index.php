...
top: 21px;"/></a></li>
        ...
        <div id="logo">
            ...
            <div id="logo-right3">
            	<div><div id="anh"><img src="png/call2.png" /></div>SUPPORT : 0377776357</div>
            </div>
        </div>
        <div id="menu">
        	<ul >
        ...
        <div id="lh_1">
         ...
         <div id="content-center">
         	<div id="quangcao"><img src="dangnhapthanhcong/products/WAMmwq - Copy.jpg"  width="480px" height="140px"/> </div>
            <div class="sanpham">
            
                    <p style="padding-left: 25px;"><span style="background-color:rgb(255, 0, 106);font-size: 17px;border-radius: 3px; font-weight: bold;color:white;"> Sản phẩm bán chạy</span></p>
           	    <ul>
                    <?php
                    ...
                    <p style="padding-left:25px;"> <span style="background-color:rgb(255, 0, 106);font-size: 18px;border-radius: 3px; font-weight: bold;color:white;">Sản phẩm mới</span> <img src="dangnhapthanhcong/products/imgres.png"width="28px" height="28px"/> </p>  
               <ul>
                	     <?php
