	...
	<div id="wrapper">
    	<div id="top">
        	<div id="top-left">
            	...
            	<ul>
                	<li><a href="#"><img src="png/login.png" style="position:absolute;right: 188px; top: 21px;"/></a></li>
                    <li>|</li>
        ...
        <div id="logo">
            ...
            <div id="logo-right3">
            	<div><div id="anh"><img src="dangnhapthanhcong/products/call2.png" /></div>SUPPORT : 0979433225</div>
            </div>
        </div>
        <div id="menu">
        	<ul >
		       <li><img src="dangnhapthanhcong/products/home.png" width="40px" height="40px" style="float:left; padding:15px 0px 10px 30px;"/></li>
        ...
        <div id="lh_1">
            <div id="lg_lh"><p>Liên H&#7879; H&#7895; tr&#7903;</p></div>
            <img src="dangnhapthanhcong/products/hotline.png" width='200px' height='100px'/>
            <img src="dangnhapthanhcong/products/giolamviec.png" width='200px' height='100px' style="margin-bottom: 20px;" />
         </div>
        </div>